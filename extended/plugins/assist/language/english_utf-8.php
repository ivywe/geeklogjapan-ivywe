<?php
###############################################################################
# plugins/assist/language/english_utf-8.php
###############################################################################
## Admin
...
Set path(directory and file name) or URL.<br'.XHTML.'>
xml file is imported.<br'.XHTML.'>
Log file is assist_xmlimport.log.<br'.XHTML.'>
';
